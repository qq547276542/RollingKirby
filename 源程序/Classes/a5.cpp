...
bool HelloWorld::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",5);
...
#define MUSIC_FILE "backmusic.mp3"
	...
	////////篮球//////
	/*CCSprite *lanqiu = CCSprite::create("篮球.png");
	lanqiu->setScale(0.3);
	this->addChild(lanqiu);
	cocos2d::CCPoint locationlan =ccp(299,400);
	this->addNewbasketball( locationlan, lanqiu );*/
	init_num();
	///////////////////////////////////////////////////////////////////////
	//////////////////////////////////////////////////////////////////////////////////////////////////////////
	//初始化布局--------------------------------------------------begin
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////
	addNewyouxia(ccp(60,400));
	addNewyoushang(ccp(140,310));
	addNewyouxia(ccp(60,230));
	addNewyou(ccp(598,300));
	addNewenemy(ccp(300,300));
	addNewenemy(ccp(740,420));
	addNewstar(ccp(685,300));
	addNewstar(ccp(220,230));
	addNewstar(ccp(360,300));
	addNewfinish(ccp(685,100));
	
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("a5.tmx");  
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
void HelloWorld::addNewbasketball( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
...
void HelloWorld::youshang( CCPoint point, CCSprite *sprite )
{
	...
	//////////////////////////////
	fixtureDef.density = 0.1f;//设置密度
	fixtureDef.friction = 1.0f;//设置摩擦，当然还可以设置恢复，即反弹，这里我就不一一赘述
	body->CreateFixture( &fixtureDef );
