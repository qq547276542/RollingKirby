...
bool HelloWorld2::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",11);
...
#define MUSIC_FILE "xuedi_music.mp3"
	...
	addNewstar(ccp(470,160));
	addNewfinish(ccp(150,120));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("b1.tmx");  
