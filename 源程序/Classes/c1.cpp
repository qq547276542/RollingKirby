...
bool HelloWorld3::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",21);
...
#define MUSIC_FILE "tk_music.mp3"
	...
	addNewstar(ccp(410,360));
	addNewfinish(ccp(750,90));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("c1.tmx");  
