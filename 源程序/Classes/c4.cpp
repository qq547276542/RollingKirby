...
bool HelloWorld3::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",24);
...
#define MUSIC_FILE "tk_music.mp3"
	...
	addNewstar(ccp(620,200));
	addNewstar(ccp(310,255));
	addNewfinish(ccp(755,90));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("c4.tmx");  
