...
bool HelloWorld2::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",13);
...
#define MUSIC_FILE "xuedi_music.mp3"
	...
	addNewstar(ccp(750,120));
	addNewstar(ccp(50,120));
	addNewfinish(ccp(400,40));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("b3.tmx");  
