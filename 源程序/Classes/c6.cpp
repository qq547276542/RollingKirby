...
bool HelloWorld3::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",26);
...
#define MUSIC_FILE "tk_music.mp3"
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////
	addNewenemy(ccp(340,360));
	addNewfire(ccp(420,240));
	addNewfire(ccp(600,180));
	addNewfire(ccp(600,300));
	addNewfire(ccp(650,180));
	addNewfire(ccp(650,300));
	addNewfire(ccp(500,300));
	addNewstar(ccp(500,240));
	addNewstar(ccp(200,240));
	addNewstar(ccp(600,240));
	addNewstar(ccp(200,80));
	addNewstar(ccp(350,120));
	addNewfinish(ccp(750,240));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("c6.tmx");  
