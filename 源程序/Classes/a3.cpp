...
bool HelloWorld::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",3);
...
#define MUSIC_FILE "backmusic.mp3"
	...
	addNewfire(ccp(760,450));            
	addNewstar(ccp(400,350));
	addNewstar(ccp(640,380));
	addNewstar(ccp(580,290));
	addNewfinish(ccp(760,120));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("a3.tmx");  
