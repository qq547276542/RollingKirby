...
bool HelloWorld2::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",14);
...
#define MUSIC_FILE "xuedi_music.mp3"
    ...
    CCSprite* pSprite = CCSprite::create("background4.jpg");
	...
	//addNewenemy(ccp(450,200));
	addNewfire(ccp(770,440));
	//addNewfire(ccp(190,150));
	addNewstar(ccp(720,420));
	//addNewstar(ccp(730,300));
	addNewfinish(ccp(130,120));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("b4.tmx");  
