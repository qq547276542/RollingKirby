...
bool HelloWorld3::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",23);
...
#define MUSIC_FILE "tk_music.mp3"
	...
	/*addNewfire(ccp(120,380));
	addNewfire(ccp(220,330));
	addNewfire(ccp(320,280));
	addNewfire(ccp(420,230));
	addNewfire(ccp(520,180));
	addNewfire(ccp(620,130));
	addNewfire(ccp(260,20));
	addNewfire(ccp(320,20));
	addNewfire(ccp(380,20));
	addNewfire(ccp(440,20));
	addNewfire(ccp(500,20));
	addNewfire(ccp(560,20));
	addNewfire(ccp(620,20));*/
	addNewenemy(ccp(400,240));
	addNewenemy(ccp(400,400));
	addNewenemy(ccp(400,120));
	addNewstar(ccp(755,90));
	addNewfinish(ccp(40,90));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("c3.tmx");  
