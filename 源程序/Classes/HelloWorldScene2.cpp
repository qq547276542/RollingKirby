...
void HelloWorld2::setthings_num()
{
	mk_num=9;
	zt_num=8;
	th_num=9;
...
bool HelloWorld2::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",2);
...
#define MUSIC_FILE "xuedi_music.mp3"
	...
	CCMenuItemImage *pCloseItemz = CCMenuItemImage::create(
		...
		"zanting.png",
		this,
		menu_selector(HelloWorld2::zanting));
	...
	pCloseItem->setPosition(ccp(62 , size.height/1.05-4));
	...
	CCMenuItemImage *pCloseItem1 = CCMenuItemImage::create(
		...
		"mt2.png",
		this,
		menu_selector(HelloWorld2::setcase1));
	...
	CCMenuItemImage *pCloseItem2 = CCMenuItemImage::create(
		...
		"zk2.png",
		this,
		menu_selector(HelloWorld2::setcase2));
	...
	CCMenuItemImage *pCloseItem3 = CCMenuItemImage::create(
		...
		"th2.png",
		this,
		menu_selector(HelloWorld2::setcase3));
	...
	CCMenuItemImage *pCloseItem4 = CCMenuItemImage::create(
		...
		"mx2.png",
		this,
		menu_selector(HelloWorld2::setcase4));
	...
	CCMenuItemImage *pCloseItem5 = CCMenuItemImage::create(
		...
		"tq2.png",
		this,
		menu_selector(HelloWorld2::setcase5));
	...
	CCMenuItemImage *pCloseItem6 = CCMenuItemImage::create(
		...
		"ls2.png",
		this,
		menu_selector(HelloWorld2::setcase6));
	...
	CCMenuItemImage *pCloseItem7 = CCMenuItemImage::create(
		...
		"xsp2.png",
		this,
		menu_selector(HelloWorld2::setcase7));
	...
	CCMenuItemImage *pCloseItem8 = CCMenuItemImage::create(
		...
		"xxp2.png",
		this,
		menu_selector(HelloWorld2::setcase8));
	...
	p7->setRotation(-12);
	this->addChild(p7,1000);

	

    CCSprite* pSprite = CCSprite::create("xuedi_background.jpg");
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	/////////////////////////////////////////////////////////////////////
	/*addNewyou(ccp(50,326));
	addNewyou(ccp(100,300));
	addNewyou(ccp(150,274));
	addNewyou(ccp(200,248));
	addNewzhong(ccp(275,235));
	addNewzhong(ccp(375,235));
	addNewzhong(ccp(475,235));
	addNewzhong(ccp(575,235));
	addNewzuo(ccp(780,180));
	addNewzuo(ccp(730,154));
	addNewzuo(ccp(680,128));
	addNewzhong(ccp(605,115));
	addNewzhong(ccp(505,115));
	addNewzhong(ccp(405,115));
	addNewzhong(ccp(305,115));
	addNewzuo(ccp(230,102));
	addNewzhong(ccp(160,89));
	addNewyou(ccp(85,102));
	addNewenemy(ccp(100,200));
	addNewenemy(ccp(200,200));
	addNewenemy(ccp(300,200));
	addNewenemy(ccp(400,200));
	addNewenemy(ccp(500,200));
	addNewenemy(ccp(600,200));
	addNewfire(ccp(200,100));
	addNewfire(ccp(300,100));
	addNewstar(ccp(360,40));
	addNewstar(ccp(180,40));
	addNewstar(ccp(300,40));
	addNewfinish(ccp(800,40));*/
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("test.tmx");  
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HelloWorld2::addNewSpriteWithCoords( CCPoint point, CCSprite *sprite )
{
	...
	fixtureDef.friction = 0.00002f;//设置摩擦，当然还可以设置恢复，即反弹，这里我就不一一赘述
...
void HelloWorld2::addNewmk( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
	bodyDef.type = b2_dynamicBody;//使刚体能够在力的作用下运行，刚体有三种：静态的、运动的、动态的
...
void HelloWorld2::addNewzt( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
	bodyDef.type = b2_dynamicBody;//使刚体能够在力的作用下运行，刚体有三种：静态的、运动的、动态的
...
void HelloWorld2::addNewth( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	had_th++;
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::addNewtx( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
	bodyDef.type = b2_dynamicBody;//使刚体能够在力的作用下运行，刚体有三种：静态的、运动的、动态的
	...
	fixtureDef.friction = 0.4f;//设置摩擦，当然还可以设置恢复，即反弹，这里我就不一一赘述
	body->CreateFixture( &fixtureDef );
	//给body施加一个力
	b2Vec2 force = body->GetWorldVector(b2Vec2(00.0f,0.0f));
	b2Vec2 point_force = body->GetWorldPoint( b2Vec2(0.4f,0.4f) );
...
void HelloWorld2::addNewjs( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	had_js++;
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::addNewls( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
	bodyDef.type = b2_dynamicBody;//使刚体能够在力的作用下运行，刚体有三种：静态的、运动的、动态的
...
void HelloWorld2::addNewtukuai( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
	bodyDef.type = b2_staticBody;//使刚体能够在力的作用下运行，刚体有三种：静态的、运动的、动态的
	...
	fixtureDef.shape = &dynamicBox;//绑定形状
	fixtureDef.density = 18.0f;//设置密度
	fixtureDef.friction = 0.05f;//设置摩擦，当然还可以设置恢复，即反弹，这里我就不一一赘述
	body->CreateFixture( &fixtureDef );
	//给body施加一个力
...
///////////////////////////////
bool HelloWorld2::isbong(CCPoint p1,float r1,CCPoint p2,float r2){
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HelloWorld2::update( float dt )//注意，之前2dx的版本是用ccTime的，在2.0.3版本中，用float类型
{
...
void HelloWorld2::ccTouchesBegan(CCSet *pTouches,CCEvent *pEvent)
{
...
void HelloWorld2::ccTouchesMoved(CCSet *pTouches, CCEvent *pEvent)
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	int count = pTouches->count();
	for( CCSetIterator iterTouch = pTouches->begin();iterTouch != pTouches->end();iterTouch++)
...
void HelloWorld2::ccTouchesEnded( CCSet *pTouches, CCEvent *pEvent)
{
...
void HelloWorld2::restart(CCObject* pSender)
{
	SimpleAudioEngine::sharedEngine()->playEffect("zanting.wav");
	CCDirector::sharedDirector()->resume();
	begin_back=1;
	CCScene * scene2=HelloWorld2::scene();
	CCDirector::sharedDirector()->replaceScene(scene2);
}

void HelloWorld2::continuescene(CCObject* pSender)
{
	SimpleAudioEngine::sharedEngine()->playEffect("zanting.wav");
	CCDirector::sharedDirector()->resume();
	begin_back=1;
...
void HelloWorld2::zanting(CCObject* pSender)
{
	/*SimpleAudioEngine::sharedEngine()->playEffect("zanting.wav");
	...
	CCMenuItemImage *pCloseItem = CCMenuItemImage::create(
		...
		"restart.png",
		this,
		menu_selector(HelloWorld2::restart));
	...
	CCMenuItemImage *pCloseItem1 = CCMenuItemImage::create(
		...
		"continue.png",
		this,
		menu_selector(HelloWorld2::continuescene));
	...
	CCMenuItemImage *pCloseItem2 = CCMenuItemImage::create(
		...
		"zhuye.png",
		this,
		menu_selector(HelloWorld2::remenu));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HelloWorld2::setcase1(CCObject* pSender)
{
	clickcase=1;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld2::setcase2(CCObject* pSender)
{
	clickcase=2;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld2::setcase3(CCObject* pSender)
{
	clickcase=3;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld2::setcase4(CCObject* pSender)
{
	clickcase=4;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld2::setcase5(CCObject* pSender)
{
	clickcase=5;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld2::setcase6(CCObject* pSender)
{
	clickcase=6;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld2::setcase7(CCObject* pSender)
{
	clickcase=7;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld2::setcase8(CCObject* pSender)
{
	clickcase=8;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
...
///////////////////////////////////////////////////////////////////////
void HelloWorld2::addNewyoushang(cocos2d::CCPoint point)
{
	////添加右上斜杆///////
...
void HelloWorld2::addNewyouxia(cocos2d::CCPoint point)
{
	//////////////////////////////////////////////////////////////////////
	////添加右下斜杆///////
...
void HelloWorld2::addNewyou(cocos2d::CCPoint point)
{
	////添加右斜杆///////
...
void HelloWorld2::addNewzuo(cocos2d::CCPoint point)
{
	//////////////////////////////////////////////////////////////////////
	////添加左斜杆///////
...
void HelloWorld2::addNewzhong(cocos2d::CCPoint point)
{
	//////////////////////////////////////////////////////////////////////
	////添加中杆///////
...
void HelloWorld2::addNewshu(cocos2d::CCPoint point)
{
	//////////////////////////////////////////////////////////////////////
	////添加竖杆///////
...
void HelloWorld2::addNewCaoping( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::youshang( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::youxia( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::youshangpo( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::youxiapo( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::you( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::zuo( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::zhong( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::shu( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld2::addNewenemy(cocos2d::CCPoint point)
{
	enemy1_num++;
...
void HelloWorld2::addNewfire(cocos2d::CCPoint point)
{
	fire_num++;
...
void HelloWorld2::addNewstar(cocos2d::CCPoint point)
{
	star_num++;
...
void HelloWorld2::addNewfinish(cocos2d::CCPoint point)
{
...
//切换动画完成后调用的函数
void HelloWorld2::onEnterTransitionDidFinish(){
	CCLayer::onEnterTransitionDidFinish();
}



void HelloWorld2::gameover()
{
	SimpleAudioEngine::sharedEngine()->stopBackgroundMusic();
...
void HelloWorld2::remenu(CCObject* psender)
{
	CCDirector::sharedDirector()->resume();
