...
bool HelloWorld3::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",25);
...
#define MUSIC_FILE "tk_music.mp3"
	...
	addNewenemy(ccp(260,10));
	addNewenemy(ccp(340,10));
	addNewenemy(ccp(420,10));
	addNewenemy(ccp(500,10));
	addNewenemy(ccp(580,10));
	addNewenemy(ccp(660,10));
	addNewstar(ccp(550,80));
	addNewstar(ccp(450,80));
	addNewstar(ccp(350,80));
	addNewfinish(ccp(755,110));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("c5.tmx");  
