...
bool HelloWorld3::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",22);
...
#define MUSIC_FILE "tk_music.mp3"
	...
	addNewfire(ccp(380,250));
	addNewstar(ccp(50,80));
	addNewstar(ccp(470,300));
	addNewenemy(ccp(200,100));
	addNewfinish(ccp(760,440));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("c2.tmx");  
