...
bool HelloWorld2::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",12);
...
#define MUSIC_FILE "xuedi_music.mp3"
	...
	addNewfire(ccp(740,420));
	addNewfire(ccp(190,150));
	addNewstar(ccp(450,150));
	addNewstar(ccp(450,340));
	addNewfinish(ccp(748,135));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("b2.tmx");  
