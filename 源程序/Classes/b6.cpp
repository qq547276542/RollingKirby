...
bool HelloWorld2::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",16);
...
#define MUSIC_FILE "xuedi_music.mp3"
	...
	addNewstar(ccp(480,30));
	addNewstar(ccp(530,370));
	addNewfinish(ccp(740,100));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("b6.tmx");  
