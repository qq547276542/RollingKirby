...
bool HelloWorld2::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",15);
...
#define MUSIC_FILE "xuedi_music.mp3"
	...
	addNewstar(ccp(720,40));
	//addNewstar(ccp(30,300));
	addNewfinish(ccp(90,40));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("b5.tmx");  
