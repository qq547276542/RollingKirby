...
#define MUSIC_FILE "backmusic.mp3"
	...
	addNewenemy(ccp(330,370));
	addNewfire(ccp(330,230));              
	addNewstar(ccp(390,370));
	addNewstar(ccp(620,180));
	addNewstar(ccp(540,290));
	addNewfinish(ccp(520,120));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("a2.tmx");  
