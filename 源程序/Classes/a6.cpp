...
bool HelloWorld::init()
{
	...
	CCUserDefault::sharedUserDefault()->setIntegerForKey("scene_num",6);
...
#define MUSIC_FILE "backmusic.mp3"
	...
	addNewenemy(ccp(480,155));
	addNewenemy(ccp(340,155));
	addNewenemy(ccp(220,155));
	addNewenemy(ccp(530,40));
	addNewenemy(ccp(390,40));
	addNewenemy(ccp(260,40));
	addNewfire(ccp(590,155));
	addNewstar(ccp(100,70));
	addNewstar(ccp(540,190));
	addNewfinish(ccp(730,30));
	
	cocos2d::CCTMXTiledMap *_tileMap; 
	_tileMap=CCTMXTiledMap::create("a6.tmx");  
