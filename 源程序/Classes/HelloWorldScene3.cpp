...
void HelloWorld3::setthings_num()
{
	mk_num=9;
	zt_num=8;
	th_num=9;
...
#define MUSIC_FILE "tk_music.mp3"
	    SimpleAudioEngine::sharedEngine()->preloadEffect("zhangshen.wav");
		  SimpleAudioEngine::sharedEngine()->preloadEffect("change_g.wav");
	...
	/*CCMenuItemImage *pCloseItemz = CCMenuItemImage::create(
		...
		"zanting.png",
		this,
		menu_selector(HelloWorld3::zanting));
	...
	CCMenuItemImage *pCloseItem = CCMenuItemImage::create(
		...
		"start.png",
		this,
		menu_selector(HelloWorld3::menuCloseCallback));
	...
	CCMenuItemImage *pCloseItem1 = CCMenuItemImage::create(
		...
		"mt2.png",
		this,
		menu_selector(HelloWorld3::setcase1));
	...
	CCMenuItemImage *pCloseItem2 = CCMenuItemImage::create(
		...
		"zk2.png",
		this,
		menu_selector(HelloWorld3::setcase2));
	...
	CCMenuItemImage *pCloseItem3 = CCMenuItemImage::create(
		...
		"th2.png",
		this,
		menu_selector(HelloWorld3::setcase3));
	...
	CCMenuItemImage *pCloseItem4 = CCMenuItemImage::create(
		...
		"mx2.png",
		this,
		menu_selector(HelloWorld3::setcase4));
	...
	CCMenuItemImage *pCloseItem5 = CCMenuItemImage::create(
		...
		"tq2.png",
		this,
		menu_selector(HelloWorld3::setcase5));
	...
	CCMenuItemImage *pCloseItem6 = CCMenuItemImage::create(
		...
		"ls2.png",
		this,
		menu_selector(HelloWorld3::setcase6));
	...
	CCMenuItemImage *pCloseItem7 = CCMenuItemImage::create(
		...
		"xsp2.png",
		this,
		menu_selector(HelloWorld3::setcase7));
	...
	CCMenuItemImage *pCloseItem8 = CCMenuItemImage::create(
		...
		"xxp2.png",
		this,
		menu_selector(HelloWorld3::setcase8));
    ...
    CCSprite* pSprite = CCSprite::create("tk_background.png");
    pSprite->setPosition(ccp(size.width/2 , size.height/2 ));
	pSprite->setScaleX(0.8);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HelloWorld3::addNewSpriteWithCoords( CCPoint point, CCSprite *sprite )
{
...
void HelloWorld3::addNewmk( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
	bodyDef.type = b2_dynamicBody;//使刚体能够在力的作用下运行，刚体有三种：静态的、运动的、动态的
...
void HelloWorld3::addNewzt( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
	bodyDef.type = b2_dynamicBody;//使刚体能够在力的作用下运行，刚体有三种：静态的、运动的、动态的
...
void HelloWorld3::addNewth( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	had_th++;
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::addNewtx( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
	bodyDef.type = b2_dynamicBody;//使刚体能够在力的作用下运行，刚体有三种：静态的、运动的、动态的
...
void HelloWorld3::addNewjs( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	had_js++;
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::addNewls( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
	bodyDef.type = b2_dynamicBody;//使刚体能够在力的作用下运行，刚体有三种：静态的、运动的、动态的
...
void HelloWorld3::addNewtukuai( cocos2d::CCPoint point, cocos2d::CCSprite *sprite )
{
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
	bodyDef.type = b2_staticBody;//使刚体能够在力的作用下运行，刚体有三种：静态的、运动的、动态的
...
///////////////////////////////
bool HelloWorld3::isbong(CCPoint p1,float r1,CCPoint p2,float r2){
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HelloWorld3::update( float dt )//注意，之前2dx的版本是用ccTime的，在2.0.3版本中，用float类型
{
...
void HelloWorld3::ccTouchesBegan(CCSet *pTouches,CCEvent *pEvent)
{
	if(gy!=0)
	{
b2Vec2 s=world->GetGravity();
	world->SetGravity(-s);
	SimpleAudioEngine::sharedEngine()->playEffect("change_g.wav");
	}
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HelloWorld3::menuCloseCallback(CCObject* pSender)
{
...
void HelloWorld3::restart(CCObject* pSender)
{
	SimpleAudioEngine::sharedEngine()->playEffect("zanting.wav");
	CCDirector::sharedDirector()->resume();
	begin_back=1;
	CCScene * scene2=HelloWorld3::scene();
	CCDirector::sharedDirector()->replaceScene(scene2);
}

void HelloWorld3::continuescene(CCObject* pSender)
{
	SimpleAudioEngine::sharedEngine()->playEffect("zanting.wav");
	CCDirector::sharedDirector()->resume();
	begin_back=1;
...
void HelloWorld3::zanting(CCObject* pSender)
{
	/*SimpleAudioEngine::sharedEngine()->playEffect("zanting.wav");
	...
	CCMenuItemImage *pCloseItem = CCMenuItemImage::create(
		...
		"restart.png",
		this,
		menu_selector(HelloWorld3::restart));
	...
	CCMenuItemImage *pCloseItem1 = CCMenuItemImage::create(
		...
		"continue.png",
		this,
		menu_selector(HelloWorld3::continuescene));
	...
	CCMenuItemImage *pCloseItem2 = CCMenuItemImage::create(
		...
		"zhuye.png",
		this,
		menu_selector(HelloWorld3::remenu));
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void HelloWorld3::setcase1(CCObject* pSender)
{
	clickcase=1;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld3::setcase2(CCObject* pSender)
{
	clickcase=2;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld3::setcase3(CCObject* pSender)
{
	clickcase=3;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld3::setcase4(CCObject* pSender)
{
	clickcase=4;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld3::setcase5(CCObject* pSender)
{
	clickcase=5;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld3::setcase6(CCObject* pSender)
{
	clickcase=6;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld3::setcase7(CCObject* pSender)
{
	clickcase=7;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
void HelloWorld3::setcase8(CCObject* pSender)
{
	clickcase=8;
	SimpleAudioEngine::sharedEngine()->playEffect("button.WAV");
}
...
///////////////////////////////////////////////////////////////////////
void HelloWorld3::addNewyoushang(cocos2d::CCPoint point)
{
	////添加右上斜杆///////
...
void HelloWorld3::addNewyouxia(cocos2d::CCPoint point)
{
	//////////////////////////////////////////////////////////////////////
	////添加右下斜杆///////
...
void HelloWorld3::addNewyou(cocos2d::CCPoint point)
{
	////添加右斜杆///////
...
void HelloWorld3::addNewzuo(cocos2d::CCPoint point)
{
	//////////////////////////////////////////////////////////////////////
	////添加左斜杆///////
...
void HelloWorld3::addNewzhong(cocos2d::CCPoint point)
{
	//////////////////////////////////////////////////////////////////////
	////添加中杆///////
...
void HelloWorld3::addNewshu(cocos2d::CCPoint point)
{
	//////////////////////////////////////////////////////////////////////
	////添加竖杆///////
...
void HelloWorld3::addNewCaoping( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::youshang( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::youxia( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::youshangpo( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::youxiapo( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::you( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::zuo( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::zhong( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::shu( CCPoint point, CCSprite *sprite )
{
	CCSize size = CCDirector::sharedDirector()->getWinSize();
	sprite->setPosition(point);
	b2BodyDef bodyDef;//定义刚体
...
void HelloWorld3::keyBackClicked()
{
	if(begin_back)
	{
		zanting1();
...
void HelloWorld3::keyMenuClicked()
{
	if(begin_back)
	{
		zanting1();
...
void HelloWorld3::addNewenemy(cocos2d::CCPoint point)
{
	enemy1_num++;
...
void HelloWorld3::addNewfire(cocos2d::CCPoint point)
{
	fire_num++;
...
void HelloWorld3::addNewstar(cocos2d::CCPoint point)
{
	star_num++;
...
void HelloWorld3::addNewfinish(cocos2d::CCPoint point)
{
...
//进入此类中的调用函数
void HelloWorld3::onEnter(){
	CCLayer::onEnter();
}

//切换动画完成后调用的函数
void HelloWorld3::onEnterTransitionDidFinish(){
	CCLayer::onEnterTransitionDidFinish();
}



void HelloWorld3::gameover()
{
	SimpleAudioEngine::sharedEngine()->stopBackgroundMusic();
...
void HelloWorld3::remenu(CCObject* psender)
{
	CCDirector::sharedDirector()->resume();
